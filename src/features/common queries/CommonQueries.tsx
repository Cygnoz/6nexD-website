...
function CommonQueries() {
    ...
    <>
      <div className="relative  w-full min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-white py-16">
          <h1 className="text-4xl font-bold mb-4 font-sans text-center">Answers to Common Queries</h1>
          <p className="text-lg font-sans text-center max-w-2xl">
  ...
  <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
    ...
    {/* Card 1 */}
    <div className="relative overflow-hidden rounded-lg p-4 min-h-[100px]  bg-transparent bg-center w-full md:w-[400px]">
  ...
  {/* Bottom row flexbox */}
  <div className="flex flex-col md:flex-row mt-32 justify-between gap-4">
    {/* Card 3 */}
    <div className="relative overflow-hidden rounded-lg p-4 min-h-[100px] bg-transparent bg-center w-full md:w-[400px]">
      <div className="absolute inset-0 bg-black/50" />
      <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-2">
