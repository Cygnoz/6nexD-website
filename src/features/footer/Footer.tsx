...
const Footer: React.FC = () => {
  return (
    ...
    <div className="relative z-10 flex flex-col items-center text-white py-10 md:py-16">
      <footer className="bg-black text-gray-400 py-10 md:py-12 shadow-lg shadow-[#6B6B6B17] rounded-lg px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center md:items-start">
              ...
              <img 
                src={nexd} 
                className="w-14 md:w-18 h-6 md:h-8 mb-2" 
                alt="" 
              />
            </div>
